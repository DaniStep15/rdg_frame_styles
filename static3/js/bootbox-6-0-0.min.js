        ...
        (r.dialog = function(e) {
            ...
            ;(e = (function(a) {
                ...
                ;(a = s.extend({}, p, a)).backdrop
                    ? (a.backdrop = 'string' != typeof a.backdrop || 'static' !== a.backdrop.toLowerCase() || 'static')
            ...
            if (
                ...
                switch (
                    (e.fullBootstrapVersion.substring(0, 3) < '3.1' &&
                        console.warn('"size" requires Bootstrap 3.1.0 or higher. You appear to be using ' + e.fullBootstrapVersion + '. Please upgrade to use this option.'),
                    e.size)
                ) {
                    case 'small':
                    case 'sm':
                    ...
                    case 'xl':
                        t.addClass('modal-xl'),
                            e.fullBootstrapVersion.substring(0, 3) < '4.2' &&
                                console.warn(
                                    'Using size "xl"/"extra-large" requires Bootstrap 4.2.0 or higher. You appear to be using ' + e.fullBootstrapVersion + '. Please upgrade to use this option.'
                                )
                }
            if (
                (e.scrollable &&
                    ...
                    e.fullBootstrapVersion.substring(0, 3) < '4.3' &&
                        console.warn('Using "scrollable" requires Bootstrap 4.3.0 or higher. You appear to be using ' + e.fullBootstrapVersion + '. Please upgrade to use this option.')),
            ...
            if (
                (e.centerVertical &&
                    ...
                    e.fullBootstrapVersion < '4.0.0' &&
                        console.warn('"centerVertical" requires Bootstrap 4.0.0-beta.3 or higher. You appear to be using ' + e.fullBootstrapVersion + '. Please upgrade to use this option.')),
            ...
            if (
                ...
                (n.buttons.confirm.callback = function() {
                    ...
                    if ('checkbox' === n.inputType)
                        ...
                        let t = i[0]
                        if ((n.errorMessage && t.setCustomValidity(''), t.checkValidity && !t.checkValidity()))
                            return n.errorMessage && t.setCustomValidity(n.errorMessage), t.reportValidity && t.reportValidity(), !1
                        e =
                ...
                case 'radio':
                    ...
                    f(l, function(t, e) {
                        ...
                        o.find('input').attr('value', e.value),
                            o.find('label').append('\n' + e.text),
                            n.value !== c && e.value === n.value && (o.find('input').prop('checked', !0), (a = !1)),
                            i.append(o)
                    }),
                        a &&
                            i
