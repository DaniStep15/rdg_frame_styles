        ...
        ;(m.VERSION = '3.4.1'),
            ...
            (m.prototype.init = function(t, e, i) {
                if (
                    ...
                    (this.$viewport =
                        ...
                        g(document).find(g.isFunction(this.options.viewport) ? this.options.viewport.call(this, this.$element) : this.options.viewport.selector || this.options.viewport)),
            ...
            (m.prototype.hide = function(t) {
                ...
                if ((this.$element.trigger(o), !o.isDefaultPrevented()))
                    return (
                        i.removeClass('in'), g.support.transition && i.hasClass('fade') ? i.one('bsTransitionEnd', n).emulateTransitionEnd(m.TRANSITION_DURATION) : n(), (this.hoverState = null), this
                    )
            }),
