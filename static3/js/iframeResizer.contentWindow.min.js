...
!(function(a) {
        ...
        R('TargetOrigin for parent set to: ' + T),
            ...
            (Q.parentIFrame = {
                autoResize: function(e) {
                    return (
                        !0 === e && !1 === r ? ((r = !0), pe()) : !1 === e && !0 === r && ((r = !1), fe('remove'), null !== s && s.disconnect(), clearInterval(B)),
            ...
            (h = (function() {
                function n(e) {
                    ...
                    return { x: parseInt(e.left, 10) + parseInt(t.x, 10), y: parseInt(e.top, 10) + parseInt(t.y, 10) }
                }
                function o(e) {
                    var e = e.split('#')[1] || e,
                    ...
                    a === t
                        ...
                        : ((t = n((t = t))), R('Moving to in page link (#' + e + ') at x: ' + t.x + ' y: ' + t.y), F(t.y, t.x, 'scrollToOffset'))
                }
                function e() {
    ...
    function fe(e) {
        t({ method: e, eventType: 'Animation Start', eventNames: ['animationstart', 'webkitAnimationStart'] }),
            t({ method: e, eventType: 'Animation Iteration', eventNames: ['animationiteration', 'webkitAnimationIteration'] }),
            t({ method: e, eventType: 'Animation End', eventNames: ['animationend', 'webkitAnimationEnd'] }),
            ...
            t({ method: e, eventType: 'Transition Start', eventNames: ['transitionstart', 'webkitTransitionStart', 'MSTransitionStart', 'oTransitionStart', 'otransitionstart'] }),
            t({
                method: e,
                eventType: 'Transition Iteration',
                eventNames: ['transitioniteration', 'webkitTransitionIteration', 'MSTransitionIteration', 'oTransitionIteration', 'otransitioniteration']
            }),
            t({ method: e, eventType: 'Transition End', eventNames: ['transitionend', 'webkitTransitionEnd', 'MSTransitionEnd', 'oTransitionEnd', 'otransitionend'] }),
                            ...
                            var u = [],
                                ...
                                s = (function() {
                                    ...
                                    return (
                                        ...
                                        s.observe(e, { attributes: !0, attributeOldValue: !1, characterData: !0, characterDataOldValue: !1, childList: !0, subtree: !0 }),
                                        s
                                    )
                                })()
                            return {
    ...
    function Ee(e, t, n, o) {
        function i() {
            e in { init: 1, interval: 1, size: 1 } || !(m in U || (d && M in U)) ? e in { interval: 1 } || R('No change in size detected') : Ie(t)
        }
        function r(e, t) {
    ...
    function L(e, t, n, o) {
        i && e in j ? R('Trigger event cancelled: ' + e) : (e in { reset: 1, resetPage: 1, init: 1 } || R('Trigger event: ' + t), ('init' === e ? Ee : re)(e, t, n, o))
    }
    function Se() {
