...
!(function(d) {
    ...
    function p(e) {
        return (
            ...
            '[' +
            ((n = 'Host page: ' + (e = e)),
            (n = window.top !== window.self ? (window.parentIFrame && window.parentIFrame.getId ? window.parentIFrame.getId() + ': ' + e : 'Nested host page: ' + e) : n)) +
            ']'
        )
        var n
    }
    ...
    function w(e) {
        ...
        function r(e) {
            ...
            return W(b), { x: Math.floor(Number(e.left) + Number(M.x)), y: Math.floor(Number(e.top) + Number(M.y)) }
        }
        function d(e) {
            ...
            O(b, 'Reposition requested from iFrame (offset x:' + n.x + ' y:' + n.y + ')'),
                window.top === window.self
                    ...
                    : R(b, 'Unable to scroll to requested position, window.parentIFrame not found')
        }
        function c() {
        ...
        function u(e) {
            ...
            n
                ? ((n = r(n)), O(b, 'Moving to in page link (#' + e + ') at x: ' + n.x + ' y: ' + n.y), (M = { x: n.x, y: n.y }), c(), O(b, '--'))
                : window.top === window.self
        ...
        function f(e) {
            var n,
                i = {}
            ;(i = 0 === Number(w.width) && 0 === Number(w.height) ? { x: (n = a(9).split(':'))[1], y: n[0] } : { x: w.width, y: w.height }),
                l(e, { iframe: w.iframe, screenX: Number(i.x), screenY: Number(i.y), type: w.type })
        }
        function l(e, n) {
            return T(b, e, n)
        }
        function m() {
            switch ((k[b] && k[b].firstRun && k[b] && (k[b].firstRun = !1), w.type)) {
                case 'close':
                    ...
                    break
                case 'message':
                    ;(n = a(6)), O(b, 'onMessage passed: {iframe: ' + w.iframe.id + ', message: ' + n + '}'), l('onMessage', { iframe: w.iframe, message: JSON.parse(n) }), O(b, '--')
                    break
                case 'mouseenter':
                    f('onMouseEnter')
                    break
                ...
                default:
                    0 === Number(w.width) && 0 === Number(w.height)
                        ? R('Unsupported message received (' + w.type + '), this is likely due to the iframe containing a later version of iframe-resizer than the parent page')
                        : i()
            }
            function e(n, i) {
                function t() {
        ...
        var g,
            ...
            w = {},
            b = null
        if ('[iFrameResizerChild]Ready' === p) for (var y in k) A('iFrame requested init', L(y), k[y].iframe, y)
        else
            x === ('' + p).slice(0, I) && p.slice(I).split(':')[0] in k
                ? ((w = n()),
                  (b = w.id),
                  k[b] && (k[b].loaded = !0),
                  (h = w.type in { true: 1, false: 1, undefined: 1 }) && O(b, 'Ignoring init message from meta parent page'),
                  !h &&
                      ((h = !0), k[(g = b)] || ((h = !1), R(w.type + ' No settings for ' + g + '. Message was: ' + p)), h) &&
                      (O(b, 'Received: ' + p), (g = !0), null === w.iframe && (R(b, 'IFrame (' + w.id + ') not found'), (g = !1)), g && o() && m()))
                : E(b, 'Ignored: ' + p)
    }
    function T(e, n, i) {
        var t = null,
    ...
    function H(o) {
        function i(e) {
            ...
            !a &&
                '0' === o[e] &&
                ((a = !0), O(r, 'Hidden iFrame detected, creating visibility listener'), (e = m())) &&
                ((n = document.querySelector('body')), new e(t).observe(n, { attributes: !0, attributeOldValue: !1, characterData: !0, characterDataOldValue: !1, childList: !0, subtree: !0 }))
        }
        function e(e) {
            var n
    ...
    function A(n, i, t, o, e) {
        function r() {
            ...
            t && 'contentWindow' in t && null !== t.contentWindow
                ? ((e = k[o] && k[o].targetOrigin), O(o, '[' + n + '] Sending msg to iframe[' + o + '] (' + i + ') targetOrigin: ' + e), t.contentWindow.postMessage(x + i, e))
    ...
    function s(t, i) {
        function e(i) {
            ...
            e &&
                ...
                F(t, 'load', function() {
                    var e, n
                    A('iFrame.onload', i, t, d, !0), (e = k[r] && k[r].firstRun), (n = k[r] && k[r].heightCalculationMethod in f), !e && n && j({ iframe: t, height: 0, width: 0, type: 'init' })
                }),
                A('init', i, t, d, !0)
        }
        function o(e) {
            ...
            2 === n.length &&
                ...
                delete this[e],
                R(r, "Deprecated: '" + e + "' has been renamed '" + n + "'. The old method will be removed in the next major version."))
        }
        function n(e) {
            if (
                ((e = e || {}),
        ...
        var r = (function(e) {
            ...
            return (
                '' === e &&
                    ((t.id = ((n = (i && i.id) || l.id + c++), null !== document.getElementById(n) && (n += c++), (e = n))),
                    (u = (i || {}).log),
        ...
        if (r in k && 'iFrameResizer' in t) R(r, 'Ignored iFrame, already setup.')
            ...
            switch (
                (n(i),
                O(r, 'IFrame scrolling ' + (k[r] && k[r].scrolling ? 'enabled' : 'disabled') + ' for ' + r),
                (t.style.overflow = !1 === (k[r] && k[r].scrolling) ? 'hidden' : 'auto'),
                k[r] && k[r].scrolling)
            ) {
                case 'omit':
                    break
            ...
            s('Height'),
                ...
                a('maxWidth'),
                a('minWidth'),
                ('number' != typeof (k[r] && k[r].bodyMargin) && '0' !== (k[r] && k[r].bodyMargin)) || ((k[r].bodyMarginV1 = k[r].bodyMargin), (k[r].bodyMargin = k[r].bodyMargin + 'px')),
                e(L(r)),
                k[r] &&
    ...
    'undefined' != typeof window &&
        ...
        (f = Object.freeze({ max: 1, scroll: 1, bodyScroll: 1, documentElementScroll: 1 })),
        (k = {}),
        (i = null),
        (l = Object.freeze({
            autoResize: !0,
        ...
        'function' == typeof define && define.amd ? define([], n) : 'object' == typeof module && 'object' == typeof module.exports && (module.exports = n()),
